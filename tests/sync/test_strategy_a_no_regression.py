...
def test_export_graphml_uses_graph_projector():
    ...
    src = (SYNC_DIR / "graphml_writer.py").read_text(encoding="utf-8")
...
def test_graph_projector_has_enrich_into_method():
    ...
    src = (SYNC_DIR / "graph_projector.py").read_text(encoding="utf-8")
